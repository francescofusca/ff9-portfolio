...
const universityProjectsData = {
  en: [
    {
      id: 1,
      title: "Avventura Sila Park — Adventure Park Management System",
      period: "Jul 2026",
      association: "Information Systems Laboratory — University of Calabria",
      description: "Desktop app for managing an adventure park: bookings with QR-code check-in, customers, packages, payments and weekly reports. Built in Java (Swing) on MySQL, with business rules enforced by database triggers.",
      tech: ["Java", "Swing", "MySQL"],
      link: "https://github.com/francescofusca/progetto_v2",
    },
    {
      id: 2,
      ...
      description: "Data Mining project predicting a student's outcome — Dropout, Enrolled or Graduate — from demographic, socio-economic and first-year academic data. The goal is to flag students at risk early, so targeted support can be put in place.",
    ...
    },
    {
      ...
      period: "Sep 2025",
      association: "In association with University of Calabria",
      description: "Web-based e-commerce for wine sales, built for the Hostaria de Mendoza restaurant in Rende (Cosenza). Customers browse the catalog and manage orders, while admins control the whole system from a dedicated panel.",
    ...
    },
    {
      ...
      period: "Ongoing",
      association: "In association with University of Calabria",
      description: "Mobile app for Android and iOS focused on powerlifting. Still under active development to deliver a fully finalized 100% complete app.",
      tech: ["Kotlin"],
      link: "https://github.com/francescofusca/powerlifting-judge",
    },
  ],
  it: [
    {
      id: 1,
      title: "Avventura Sila Park — Sistema di Gestione Parco Avventura",
      period: "Lug 2026",
      association: "Laboratorio di Sistemi Informativi — Università della Calabria",
      description: "App desktop per la gestione di un parco avventura: prenotazioni con check-in tramite QR code, clienti, pacchetti, pagamenti e report settimanali. Realizzata in Java (Swing) su MySQL, con regole di business applicate tramite trigger del database.",
      tech: ["Java", "Swing", "MySQL"],
      link: "https://github.com/francescofusca/progetto_v2",
    },
    {
      ...
      description: "Progetto di Data Mining che prevede l'esito di uno studente — Abbandono, Iscritto o Laureato — a partire da dati demografici, socio-economici e accademici del primo anno. L'obiettivo è individuare precocemente gli studenti a rischio per attivare misure di supporto mirate.",
      tech: ["Python", "Machine Learning", "Data Mining"],
      link: "https://github.com/francescofusca/student-dropout-prediction",
    },
    {
      ...
      period: "Set 2025",
      association: "In associazione con l'Università della Calabria",
      description: "E-commerce web per la vendita di vini, realizzato per il ristorante Hostaria de Mendoza di Rende (Cosenza). I clienti sfogliano il catalogo e gestiscono gli ordini, mentre gli admin controllano l'intero sistema da un pannello dedicato.",
      tech: ["Web", "E-commerce", "Full-Stack"],
      link: "https://github.com/francescofusca/EnotecaMendoza",
    },
    {
      ...
      period: "In corso",
      association: "In associazione con l'Università della Calabria",
      description: "App mobile per Android e iOS dedicata al powerlifting. Ancora in fase di sviluppo attivo per arrivare a un'app finalizzata al 100%.",
      tech: ["Kotlin"],
      link: "https://github.com/francescofusca/powerlifting-judge",
    },
  ],
